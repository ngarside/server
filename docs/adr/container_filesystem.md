...
one container must read the logs written by another container. They must always
be mutable and placed in an application-specific directory under `/var/log`, for
example `/var/log/caddy/*`.
