...
chcon --no-dereference --type sshd_key_t /etc/ssh/ssh_host_ecdsa_key
chcon --no-dereference --type sshd_key_t /etc/ssh/ssh_host_ecdsa_key.pub
# chcon --no-dereference --type sshd_key_t /etc/ssh/ssh_host_ed25519_key
# chcon --no-dereference --type sshd_key_t /etc/ssh/ssh_host_ed25519_key.pub
# chcon --no-dereference --type sshd_key_t /etc/ssh/ssh_host_rsa_key
# chcon --no-dereference --type sshd_key_t /etc/ssh/ssh_host_rsa_key.pub
